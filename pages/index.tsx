  ...
  <>
    ...
    <div className="home__page">
      ...
      <p className={text}>
        ...
        quia neque fugit voluptatum tenetur aspernatur nam consequatur quod
        asperiores, possimus hic reiciendis, suscipit voluptates error
        temporibus consectetur rem expeditae
      </p>
      <p className={text}>
